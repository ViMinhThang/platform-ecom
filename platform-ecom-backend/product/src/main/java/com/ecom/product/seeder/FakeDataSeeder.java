...
public class FakeDataSeeder implements CommandLineRunner {
    ...
    private void seedProducts(List<Category> categories, int count) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            Product product = Product.builder()
                    ...
                    .totalReviews(320L)
                    .averageRating(4.8)
                    .status(faker.options().option("ACTIVE", "ACTIVE", "ACTIVE", "DRAFT", "OUT_OF_STOCK"))
        ...
        switch (categoryName) {
            ...
            case "Fashion":
                return faker.options().option(
                        ...
                        "Dress", "Sweater", "Shorts", "Sneakers"
                ) + " " + faker.color().name();
            case "Home & Garden":
                return faker.options().option(
                        "Coffee Maker", "Vacuum Cleaner", "Garden Tools", "Sofa",
                        "Lamp", "Rug", "Curtains", "Planter"
                ) + " " + faker.commerce().productName();
    ...
    private Map<String, Object> generateSpecifications() {
        ...
        specs.put("material", faker.options().option("Plastic", "Metal", "Wood", "Glass", "Cotton", "Leather"));
