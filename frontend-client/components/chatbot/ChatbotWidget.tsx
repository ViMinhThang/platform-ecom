                ...
                {isOpen ? (
                    ...
                    <div className="relative">
                        ...
                        <span className="absolute -top-1 -right-1 flex h-4 w-4">
                            ...
                            <span className="relative inline-flex rounded-full h-4 w-4 bg-primary text-[10px] items-center justify-center font-bold text-white border-2 border-primary">
                                AI
                            </span>
                        </span>
                    </div>
