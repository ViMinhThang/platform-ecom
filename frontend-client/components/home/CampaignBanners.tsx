    ...
    return (
        <section className="max-w-[1600px] w-full mx-auto px-6 md:px-12 py-12">
            <div className="grid grid-cols-1 md:grid-cols-12 gap-6 h-auto md:h-[400px]">
                {/* THE BLUE ERA */}
                <div className="md:col-span-8 bg-[#d4e3ff] rounded-3xl overflow-hidden flex flex-col md:flex-row shadow-sm">
                    <div className="flex-1 p-10 md:p-16 flex flex-col justify-center space-y-6">
                        ...
                        <div>
                            <Link 
                                ...
                                className="inline-flex items-center justify-center rounded-full bg-[#0959b6] px-8 py-3 text-sm font-bold text-white shadow transition-colors hover:bg-[#001c38]"
                            >
                                Khám phá
                            </Link>
                        </div>
                ...
                {/* FLASH SALE */}
                <div className="md:col-span-4 bg-[#e8d5f3] rounded-3xl overflow-hidden relative shadow-sm group">
                    <Image
                        src="/banner-3.png"
                        alt="Flash Sale"
                        fill
                    ...
                    <div className="absolute inset-0 p-10 md:p-12 flex flex-col justify-end space-y-4">
                        ...
                        <div>
                            <Link 
                                href="/sale" 
                                className="inline-flex items-center justify-center rounded-full bg-white/20 backdrop-blur-md px-6 py-2.5 text-[11px] font-bold text-white shadow-sm transition-all hover:bg-white hover:text-purple-900 ghost-border border-white/40"
                            >
                                Xem ưu đãi
                            </Link>
                        </div>
